...
{
GameCompleteScene::GameCompleteScene(SceneManager& sceneManager, InputManager& input, AssetManager& assets, AudioManager& audio, sf::RenderWindow& window, int coins)
